...
export default function Home_Sub() {
  return (
    <View className="bg-default-color w-[351px] h-[161px] rounded-[20px] shadow-custom relative">
      ...
      {/* 버튼 - 가까운 위치 확인하기 */}
      <TouchableOpacity
        className="absolute top-[85px] left-[15px] bg-component-color w-[315px] h-[52px] rounded-[10px] shadow-custom justify-center"
      >
